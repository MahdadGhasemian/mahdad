    ...
    <ol class="relative border-l border-gray-200 dark:border-gray-700">
      ...
      <li class="mb-10 ml-6">
        ...
        <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">
          Backend Developer and DevOps Engineer at CityNet
          <span
      ...
      <li class="mb-10 ml-6">
        ...
        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
          <ul>
            <li>Developing a platform for e-Commerce digital and also a platform for food stores.</li>
            <li>Utilize such technologies as Nodejs, Golang and MongoDB to develop new applications.</li>
            <li>Build database and table structures following architecture methodology for web applications.</li>
            <li>Maintaining Hetzner’s cloud servers with Golang, Bash scripts and CI/CD pipes.</li>
          </ul>
        </p>
      </li>
      <!-- Saina Pars -->
